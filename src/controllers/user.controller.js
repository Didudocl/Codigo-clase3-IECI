...
import { createUserService, deleteUserService, getUserService, getUsersService, updateUserService, deleteUserService } from '../services/user.service.js';
...
export async function getUsers(req, res) {
    try {
        ...
        const usersFound = await getUsersService(id)
